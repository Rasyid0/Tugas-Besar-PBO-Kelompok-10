...
public class Fantasi extends JFrame implements MouseListener {
    ...
    public void initComponen(){
        ...
        l1 = new JLabel();l2 = new JLabel();l4 = new JLabel("Kategori Fantasi");
        b1 = new JButton("BACA");b2 = new JButton("BACA");
        book1 = new ImageIcon("Kunang.jpeg");book2 = new ImageIcon("Fantasi.jpeg");
    ...
    public void mouseClicked(MouseEvent e){
        if(e.getSource() == l1){
            JOptionPane.showMessageDialog(null,"Judul = Fireflies Over The Sea \n Nama Pengarang = Charissa E \n"+"Tahun dibuat = 2021","Detail Buku", JOptionPane.INFORMATION_MESSAGE);
        }
        if(e.getSource() == l2){
            JOptionPane.showMessageDialog(null,"Maaf Belum Tersedia");
        }
        if(e.getSource() == b1){
            new Kunang().setVisible(true);
            this.dispose();
        }
