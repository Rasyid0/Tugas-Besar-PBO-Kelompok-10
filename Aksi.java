...
public class Aksi extends JFrame implements MouseListener {
    ...
    public void initComponen(){
        ...
        l1 = new JLabel();l2 = new JLabel();l4 = new JLabel("Kategori Aksi");
        b1 = new JButton("BACA");b2 = new JButton("BACA");
        book1 = new ImageIcon("gelud.jpeg");book2 = new ImageIcon("alas.jpeg");
    ...
    public void mouseClicked(MouseEvent e){
        if(e.getSource() == l1){
            JOptionPane.showMessageDialog(null,"Judul = Maaf Aku Tak Menjagamu Dengan Baik \n Nama Pengarang = adiansyah ya’adiaja \n"+"Tahun dibuat = 2019","Detail Buku", JOptionPane.INFORMATION_MESSAGE);
        }
        if(e.getSource() == l2){
            JOptionPane.showMessageDialog(null,"Maaf Belum Tersedia");
        }
        if(e.getSource() == b1){
            new Maaf().setVisible(true);
            this.dispose();
        }
