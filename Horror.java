...
public class Horror extends JFrame implements MouseListener {
    ...
    public void initComponen(){
        ...
        l1 = new JLabel();l2 = new JLabel();l4 = new JLabel("Kategori Horror");
        b1 = new JButton("BACA");b2 = new JButton("BACA");
        book1 = new ImageIcon("GuruBahasaInggris.jpg");book2 = new ImageIcon("Pengantin.jpg");
