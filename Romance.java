...
public class Romance extends JFrame implements MouseListener {
    ...
    public void initComponen(){
        ...
        l1 = new JLabel();l2 = new JLabel();l4 = new JLabel("Kategori Romance");
        b1 = new JButton("BACA");b2 = new JButton("BACA");
        book1 = new ImageIcon("book1.jpg");book2 = new ImageIcon("buku1.jpg");
